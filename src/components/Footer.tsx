...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-cream text-charcoal py-28 md:py-32 px-4 sm:px-6 md:px-12 flex flex-col items-center justify-center text-center relative border-t border-rosegold/30 overflow-hidden">
      ...
      <span className="text-[10px] sm:text-[11px] uppercase tracking-[0.4em] text-rosegold font-bold mb-6 md:mb-8 relative z-10">The Art of Radiance</span>
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-light mb-12 md:mb-16 relative z-10 leading-[1.05]">
      ...
      <div className="relative p-6 sm:p-8 z-10">
        ...
        <button 
          ref={buttonRef}
          className="hover-target relative z-10 w-40 h-40 sm:w-44 sm:h-44 md:w-56 md:h-56 rounded-full bg-charcoal text-cream flex items-center justify-center overflow-hidden group"
        >
      ...
      <div className="mt-24 w-full max-w-7xl border-t border-rosegold/30 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-medium uppercase tracking-[0.2em] text-charcoal/60 relative z-10">
