...
export const Hero: React.FC<HeroProps> = ({ isReady }) => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen w-full flex flex-col lg:flex-row bg-cream text-charcoal overflow-hidden pt-20">
      {/* Left: Content Pane */}
      <div className="w-full lg:w-1/2 p-8 lg:p-16 xl:p-24 flex flex-col justify-center border-r border-rosegold/20 relative z-10">
        <p className="hero-subtitle text-[11px] md:text-sm uppercase tracking-[0.4em] text-rosegold font-bold mb-6 opacity-0">
          Refined Elegance & Care
        </p>
        <div ref={textRef}>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-light leading-[0.9] mb-8">
            <SplitText text="Samiksha" />
            <br />
            <span className="italic text-rosegold"><SplitText text="Beauty Studio" /></span>
          </h1>
        </div>
        <p className="text-sm text-charcoal/60 max-w-sm leading-relaxed mb-10">
      ...
      {/* Right: Visual Pane */}
      <div className="w-full lg:w-1/2 relative bg-blush flex items-center justify-center p-8 lg:p-12 min-h-[50vh]">
        ...
        <div className="relative w-full h-full min-h-[400px] max-h-[80vh] border border-rosegold/40 rounded-[100px] overflow-hidden flex flex-col items-center justify-center group">
